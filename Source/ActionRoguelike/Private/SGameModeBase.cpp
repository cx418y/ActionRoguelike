...
void ASGameModeBase::OnPowerupSpawnQueryCompleted(UEnvQueryInstanceBlueprintWrapper* QueryInstance, EEnvQueryStatus::Type QueryStatus)
{
	if (QueryStatus != EEnvQueryStatus::Success)
	{
		UE_LOG(LogTemp, Warning, TEXT("Spawn Poweup EQS Query Failed!"));
		return;
	}
	...
	// GEngine->AddOnScreenDebugMessage(-1, 1.0f, FColor::Black, FString::FromInt(Locations.Num()));
	UE_LOG(LogTemp, Warning, TEXT("Locations.Num is %d"), Locations.Num());
